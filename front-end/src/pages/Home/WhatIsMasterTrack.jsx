...
export const MasterTrack = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto px-2 md:px-6 py-5 md:py-20">
      ...
      >
        <h1 className="text-2xl md:text-5xl font-black text-slate-900 md:mb-8 tracking-tight">
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-6">
              <h2 className=" text-xl md:text-3xl font-black tracking-widest mb-8 drop-shadow-md">
                {card.title}
              </h2>
