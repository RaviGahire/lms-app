...
export const SuccessAndFeatures = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <SuccessSectionStats
        heading='Our Success'
        sub_heading='We empower thousands of educators and students worldwide with tools designed for the modern age of digital learning.'

      />

      {/* FEATURES SECTION */}
      <FeatureSection
        heading='All-In-One Learning Platform'
        sub_heading={`MasterTrack is one powerful online software suite that combines all the tools
...
// Success Section Stats
export const SuccessSectionStats = ({ heading, sub_heading }) => {
  const stats = [
    { value: "15K", label: "Students", color: "text-blue-500", suffix: "+" },
    { value: "75", label: "Total success", color: "text-blue-500", suffix: "%" },
    { value: "35", label: "Main questions", color: "text-blue-500", suffix: '?' },
    { value: "26", label: "Chief experts", color: "text-blue-500", suffix: '!' },
...
// Feature Section
export const FeatureSection = ({ heading, sub_heading }) => {
  const features = [
    {
