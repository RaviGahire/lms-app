             ...
             <div className="inline-flex p-1 bg-cyan-400/20 rounded-full">
                  ...
                  <Link to="/login" className="px-10 py-2.5 text-cyan-600 rounded-full font-semibold hover:bg-cyan-500/10 transition-all">
                    Login
                      ...
                      <Link to={'/signin'} className="px-10 py-2.5 bg-cyan-500 text-white rounded-full font-semibold shadow-md transition-all">
                     Register
                  </Link>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-gray-100 text-sm font-semibold mb-2 ml-4">User name</label>
                  <input
                    type="text"
                    name="userName"
                ...
                {/* 2. Email Address */}
                <div>
                  <label className="block text-gray-100 text-sm font-semibold mb-2 ml-4">Email Address</label>
                  <input
                    type="email"
                    name="email"
                ...
                {/* 3. Password */}
                <div>
                  <label className="block text-gray-100 text-sm font-semibold mb-2 ml-4">Password</label>
                ...
                <button type="submit" className="w-full cursor-pointer bg-cyan-500 text-white py-3 rounded-full font-bold text-lg hover:bg-cyan-600 active:scale-[0.98] transition mt-4 shadow-lg">
                  Register
                </button>
                {/*5. devider */}
                ...
                <button type="button" onClick={handleGoogleLogin} className="w-full cursor-pointer flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 py-3 rounded-full font-semibold text-md hover:bg-gray-50 transition active:scale-[0.98] shadow-sm">
