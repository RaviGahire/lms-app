            ...
            <div className="space-y-4">
                {
                    filterCourses.length === 0 ? (
                        <div className="p-4 rounded-2xl text-center bg-white/5 border border-white/10">
                            ...
                            <Link
                                to="/courses"
                                className="inline-block px-4 py-2 text-sm font-medium bg-white text-black rounded-lg hover:bg-gray-200 transition"
                            >
                                Get Course
                            </Link>
                        </div>
